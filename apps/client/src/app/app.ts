...
export default class App {
    ...
    private static async loadMainWindow() {
        ...
        if (App.isDevelopmentMode()) {
            urlToLoad = `http://localhost:${rendererAppPort}`;

            [REACT_DEVELOPER_TOOLS, REACT_PERF, REDUX_DEVTOOLS].map(
                (extension) => {
                    addDevtoolExtension(extension);
                },
            );
        ...
        await App.mainWindow.loadURL(urlToLoad);
    }
